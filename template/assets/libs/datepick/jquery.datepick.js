 	...
 	alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'Tampilkan tahun sebelumnya',
				nextText: '<i class="fa fa-angle-right"></i>',
				nextStatus: 'Tampilkan bulan selanjutnya',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Tampilkan tahun selanjutnya',
				currentText: 'Sekarang',
				currentStatus: 'Tampilkan bulan ini',
				todayText: 'Hari ini',
				todayStatus: 'Tampilkan hari ini',
				clearText: 'Hapus',
				clearStatus: 'Hapus semua tanda',
				closeText: 'Keluar',
				closeStatus: 'Keluar',
				yearStatus: 'Ganti tahun',
				monthStatus: 'Ganti bulan',
				weekText: 'Wk',
				weekStatus: 'Week of the year',
				dayStatus: 'Pilih DD, M d, yyyy',
