        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                    O.CaptionCont = $('<p class="CaptionCont"><label><i class="fa fa-angle-down"></i></label></p>').addClass('SlectBox').attr('style', O.E.attr('style')).prepend(O.caption);
                ...
                multiSelelect: function () {
                    ...
                    okbtn = $('<p class="btnOk">Pilih</p>').click(function () {
                    ...
                    cancelBtn = $('<p class="btnCancel">Batal</p>').click(function () {
